...
function Wordle(props) {
    const { guesses, setGuesses, history, setHistory, row, setRow, currentGuess, setCurrentGuess, disableGrid, setDisableGrid, usedLetters, setUsedLetters, receivedColors} = useContext(WordleContext);
    ...
    function handleKeyUp({ key }) {
        ...
        if (key === "Enter") {
          ...
          props.colorFunction(currentGuess);
        }
        if (key === "Backspace") {
